...
def open_image():
    ...
    submit = tkinter.Button(root , text = "Submit"  , command = call_haze , width=50,height=20)
...
def call_haze():
    ...
    quit = tkinter.Button(root , text="Quit" , command = quit_program , width=50 , height=20)
